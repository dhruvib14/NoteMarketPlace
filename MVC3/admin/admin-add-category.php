...
if(isset($_GET['category_id'])){
	$query=mysqli_query($connection,"UPDATE category SET Category_name='$category_name',Description='$description',ModifiedDate=Now(),ModifiedBy=$admin_id,IsActive=1 WHERE ID=$category_id ");
if(!$query){
	echo mysqli_error($connection);
}}
else{
$query_insert=mysqli_query($connection,"INSERT INTO category(Category_name,Description,CreatedBy,CreatedDate,IsActive) VALUES ('$category_name','$description',$admin_id,NOW(),1)");
	if(!$query_insert){
		echo mysqli_error($connection);
	}
}
				...
				<form id="basic-profile-form" method="post" action="">
					<div class="form-group row">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<label id="fname" class="form-info" for="exampleInputName">Category Name *</label>
							<input type="name" class="form-control input-field" name="category_name" placeholder="Your category name" value="<?php if(isset($_GET['category_id'])) echo $category_name;?>" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<label id="fname" class="form-info" for="exampleInputName">Description *</label>
							<textarea class="form-control" id="exampleFormControlTextarea1" name="description" placeholder="enter your description" rows="6"  required><?php if(isset($_GET['category_id'])) echo $description; ?></textarea>
						</div>
					</div>
