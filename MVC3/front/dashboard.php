					...
					<div class="row no-gutters dashboard-left">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="numbers-of-notes dashboard-box"><a href="sold-notes.php">
								...
								$query_downloads=mysqli_query($connection,"SELECT DISTINCT NoteID,DownloaderID FROM downloads WHERE IsSellerHasAllowedDownload='1'AND DownloaderID=$userid ");						
								$total_downloads=mysqli_num_rows($query_downloads);
								
								$query_rejected=mysqli_query($connection,"SELECT DISTINCT ID,SellerID FROM notes WHERE Status='10' AND SellerID=$userid ");						
								$total_rejected=mysqli_num_rows($query_rejected);


								$query_buyer_Request=mysqli_query($connection,"SELECT DISTINCT NoteID,SellerID FROM downloads WHERE IsSellerHasAllowedDownload='0' AND SellerID=$userid ");						
					...
					<div class="row no-gutters ">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="my-download dashboard-box"><a href="mydownloads.php">
									<p class="dashboard-single-details text-center"><?php echo $total_downloads;?></p>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="rejected-notes dashboard-box"><a href="myrejectednotes.php">
									<p class="dashboard-single-details text-center"><?php echo $total_rejected;?></p>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="buyer-request dashboard-box"><a href="buyer-request.php">
									<p class="dashboard-single-details text-center"><?php echo $total_buyer_Request;?></p>
...
if (isset($_POST['published-search'])) {
    ...
    $query = "SELECT notes.ID,notes.PublishedDate,notes.Note_Title, category.Category_name,referencedata.Value,notes.Price FROM notes LEFT JOIN  category ON notes.Category=category.ID LEFT JOIN referencedata ON notes.Is_Paid=referencedata.ID WHERE( notes.Note_Title LIKE '%$search_publish%' OR category.Category_name LIKE '%$search_publish%' OR notes.Price LIKE '%$search_publish%' OR referencedata.Value LIKE '%$search_publish%')AND notes.IsActive=1 AND notes.Status=9 ORDER BY notes.PublishedDate DESC ";
