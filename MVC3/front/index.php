...
<body>
  ...
  <section id="login">
      <div id="back-img">
          <img src="images/login/banner-with-overlay.jpg">
      </div>
  ...
  <div class="form-group">
    ...
    <small id="incorrect-password" class="form-text text-muted">The Password that you've entered is incorrect</small>
  </div>
