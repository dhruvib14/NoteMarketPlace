...
$downloader_Entry=mysqli_query($connection,"UPDATE downloads SET AttachmentDownloadedDate=NOW(),IsActive=1,IsAttachmentDownloaded=1,ModifiedDate=NOW(),ModifiedBy=$userid WHERE NoteID=$noteid AND DownloaderID=$userid AND IsSellerHasAllowedDownload=1");
					...
					<div class="collapse navbar-collapse">
						...
						echo "	<li class='nav-item dropdown'><a class='smooth-scroll nav-link pic-nav ' href='#' id='navbardrop' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'><img src='$profile_pic' alt='profile'></a>
								<div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
									...
									<a class='dropdown-item active' href='mydownloads.php'>My Downloads</a>
...
<?php if(isset($_SESSION['useremail'])){echo "
							<li class='nav-item'><a class='smooth-scroll nav-link' id='button-nav' href='logout.php'>
								...
								{echo "
									<li class='nav-item'><a class='smooth-scroll nav-link' onclick='javascript:logout($(this));return false;' id='button-nav' href='login1.php'>
											<p>Login</p>
										</a></li>";}?>
						</ul>
					</div>
...
var rejectedNotesTable = $('#download-notes-table').DataTable({
    "order": [[ 4, "desc" ]],
