				...
				<div class="site-nav-wrapper">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav pull-right mr-auto ">
							...
							<li class="nav-item"><a class="smooth-scroll nav-link" href="buyer-request.html">Buyer Request</a></li>
							...
							<li class="nav-item dropdown"><a class="smooth-scroll nav-link pic-nav " href="#" id="navbardrop" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="images/images/user-img.png"></a>
								<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
									...
									<a class="dropdown-item" href="sold-notes.html">My Sold Notes</a>
									<a class="dropdown-item" href="myrejectednotes.html">My Rejected Notes</a>
									<a class="dropdown-item" href="change-password.html">Change Password</a>
									<a class="dropdown-item dd-logout" href="login.html"><p>Logout</p></a>
								</div>
							</li>
					...
					<div id="mobile-nav">
						...
						<div id="mobile-nav-content">
							<ul class="navbar-nav nav">
								<li class="nav-item"><a class="smooth-scroll " href="search-notes.html">Search Notes</a></li>
								<li class="nav-item"><a class="smooth-scroll" href="dashboard.html">Sell Your Notes</a></li>
								<li class="nav-item"><a class="smooth-scroll " href="buyer-request.html">Buyer Request</a></li>
								<li class="nav-item"><a class="smooth-scroll" href="faq-page.html">FAQ</a></li>
								<li class="nav-item"><a class="smooth-scroll  " href="contactus.html">Contact Us</a></li>
								...
								<li class="nav-item"><a class="smooth-scroll " id="button-nav" href="login.html">
										<p>Logout</p>
									</a></li>
							</ul>
						</div>
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="dropleft"><a href="note-details.html"><img src="images/images/eye.png"></a>
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
										...
										<a class="dropdown-item" href="#" onclick="Report()">Report as inappropriate</a>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="star-img">
							<img class="star-img" src="images/images/star.png">
							<img class="star-img" src="images/images/star.png">
							<img class="star-img" src="images/images/star.png">
							<img class="star-img" src="images/images/star.png">
							<img class="star-img" src="images/images/star-white.png">
						</div>

						<label for="exampleInputName">Comments* </label>
						<textarea class="form-control comment input-field" rows="3" placeholder="comments"></textarea>

					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" id="modal-btn">Submit</button>
					</div>
				</div>
			</div>
		</div>
