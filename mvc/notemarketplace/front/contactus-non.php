			...
			<form id="basic-profile-form" method="post" action="contactus.php">
				<div class="form-group row">
					...
					<div class="col-md-6 col-lg-6 ">
						...
						<input type="name" class="form-control input-field" name="name" placeholder="Enter Your Full Name"  required>
						...
						<input type="name" class="form-control input-field" aria-describedby="emailHelp" name="email"  placeholder="Enter your email address"  required>
				...
				<div class=" col-md-6 col-lg-6"><div class=" form-group row">
