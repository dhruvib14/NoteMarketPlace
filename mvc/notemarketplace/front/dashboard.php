...
echo $search_progress;
	...
	$result_num = mysqli_query($connection, "SELECT COUNT(ID) FROM notes WHERE Note_Title LIKE '%$search_progress%' OR notes.Category LIKE '%$search_progress%' OR notes.Status LIKE '%$search_progress%' AND notes.IsActive=1 AND Status IN (6,7,8)");
	...
	$result = mysqli_query($connection, $query);
	$result_num = mysqli_query($connection, "SELECT COUNT(ID) FROM notes WHERE notes.IsActive=1 AND Status IN (6,7,8)");
    $row = mysqli_fetch_row($result_num);
    $total_records = $row[0];
    $total_page = ceil($total_records / $limit);
	echo $total_page;
						...
						<ul class="navbar-nav pull-right mr-auto ">
							...
							<li class="nav-item dropdown"><a class="smooth-scroll nav-link pic-nav " href="#" id="navbardrop" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="images/images/user-img.png"></a>
								<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
									...
									<a class="dropdown-item dd-logout" href="search-notes.php"><p>Logout</p></a>
								</div>
							</li>
							<li class="nav-item"><a class="smooth-scroll nav-link" id="button-nav" href="search-notes.php">
									<p>Logout</p>
								</a></li>
						</ul>
					</div>
					...
					<div id="mobile-nav">
						...
						<div id="mobile-nav-content">
							<ul class="navbar-nav nav">
								...
								<li class="nav-item"><a class="smooth-scroll " id="button-nav" href="search-notes.php">
										<p>Logout</p>
									</a></li>
							</ul>
						</div>
	...
	<section id="statistics">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 dashboard-right">
					<div class="row no-gutters ">

						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="my-download dashboard-box"><a href="mydownloads.php">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="rejected-notes dashboard-box"><a href="myrejectednotes.php">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
							<div class="buyer-request dashboard-box"><a href="buyer-request.php">
...
echo $search_publish;
	...
	$result_num2 = mysqli_query($connection, "SELECT COUNT(ID) FROM notes WHERE Note_Title LIKE '%$search_publish%' OR notes.Category LIKE '%$search_publish%' OR notes.Status LIKE '%$search_publish%' AND notes.IsActive=1 AND notes.Status=9");
    $row2 = mysqli_fetch_row($result_num);
	...
	$result2 = mysqli_query($connection, $query);
	$result_num2 = mysqli_query($connection, "SELECT COUNT(ID) FROM notes WHERE notes.IsActive=1 AND notes.Status=9");
...
?>
	...
	<section id="in-progress-notes">
						 ...
						 <?php
                                while ($row = mysqli_fetch_assoc($result2)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>$refe_data2</td> 
                                        <td>$sell_price</td>
                                        <td> <a href='note-details.php'><img src='images/images/eye.png' title='Click to View' alt='View'></a> </td>
                                         </tr>";
                                }
                                ?>
		...
		<nav aria-label="Page navigation example" id="paging">
			<ul class="pagination justify-content-center">
				<?php
                echo "<li class='page-item'><a class='page-link' href='dashboard.php?page=" . ($page2 - 1)
                    . "'><img src='images/images/left-arrow.png' alt='previous'></a></li>";
